...
void setup() {
  ...
  //pinMode(MISO, OUTPUT);
  pinMode(LED, OUTPUT);
  pinMode(ESC_L, OUTPUT);
  pinMode(ESC_R, OUTPUT);
  ...
  while(i < 250)
  {
    ...
    digitalWrite(ESC_L, HIGH);
    digitalWrite(ESC_R, HIGH);
    delayMicroseconds (1000);
    digitalWrite(ESC_C, LOW);
    digitalWrite(ESC_L, LOW);
    digitalWrite(ESC_R, LOW);
